...
Target user: the developer using the in-page aidx agent who wants to reset context or shrink a long conversation, mirroring Claude Code's `/clear` and `/compact` UX.
