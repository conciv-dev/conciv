...
<Cards>
  <Card title="Plugin" description="@opendui/aidx boots the engine and injects the widget script into your dev build." />
  <Card
    title="Widget"
    description="A chat UI in an open shadow DOM. It probes the engine and shows the ✦ button when dev routes are live."
  />
  <Card title="Engine" description="@opendui/aidx-core serves the chat, page, and test APIs on its own dev port." />
