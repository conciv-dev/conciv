...
import {CompactSpinner, ConversationSkeleton, Divider, ThinkingBubble, ThinkingSpinner} from './indicators.js'
...
export const ThinkingSpinnerStory: Story = {name: 'ThinkingSpinner', render: () => <ThinkingSpinner />}
