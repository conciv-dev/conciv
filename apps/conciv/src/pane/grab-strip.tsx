...
const GRABBER_HIT =
  'flex items-center justify-center h-4 w-24 cursor-ns-resize self-center shrink-0 touch-none focus-visible:outline-none [&:hover>div]:opacity-100 [&:hover>div]:bg-pw-text-3 [&:focus-visible>div]:opacity-100 [&:focus-visible>div]:bg-pw-accent'
const GRABBER_PILL =
