...
Spec: `docs/superpowers/specs/2026-08-15-landing-redesign-design.md` (v3). Branch `feat/landing-redesign`, worktree `/Users/omrikatz/Public/web/aidx-landing-redesign`. One implementer (conciv-site agent) executes tasks in order; the orchestrator reviews the diff after tasks 3, 6 and 9.
...
## Task 2 — Reveal + hydration-safe media query
...
## Task 3 — Hero: `install-command.tsx`, `hero.tsx` (HeroCopy), `product-frame.tsx`
...
## Task 4 — Principles strip + Capability section
...
## Task 5 — How it works + Open source ledger + nav/footer
...
## Task 6 — Delete the rest, deps, asset cleanup
...
## Task 7 — Visual evidence + `hero-demo.webp`
