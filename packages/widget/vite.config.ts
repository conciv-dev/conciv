...
// One entry (mount.tsx) ships as an ES module (`@conciv/widget`) plus code-split chunks; the dev
// plugin serves them and injects `<script type="module">`. solid-js + @conciv/extension are
...
// Match by prefix, never a hand-listed set: EVERY @conciv/extension subpath (/client carries
...
export default defineConfig({
  ...
  plugins: [solid()],
  // js-beautify (via @conciv/ui-kit-chat-tools' page-action card) ships UMD; its AMD branch lists `./lib/beautify*` paths that
