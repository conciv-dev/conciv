...
const fillTool = pageTool({
  ...
  category: 'act',
  icon: 'keyboard',
  label: {running: 'Typing into a field', done: 'Typed into a field'},
  mutating: true,
  mirrors: true,
  keywords: ['type', 'input'],
...
const selectTool = pageTool({
  ...
  category: 'act',
  icon: 'pointer',
  label: {running: 'Selecting an option', done: 'Selected an option'},
  mutating: true,
  mirrors: true,
...
const pressTool = pageTool({
  ...
  category: 'act',
  icon: 'keyboard',
  label: {running: 'Pressing a key', done: 'Pressed a key'},
  mutating: true,
  mirrors: true,
