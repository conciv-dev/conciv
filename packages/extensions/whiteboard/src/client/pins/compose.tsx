...
const PANEL =
  'absolute pointer-events-auto w-72 max-w-[calc(100vw-2rem)] flex flex-col gap-2 p-3 rounded-chat-surface-lg bg-chat-panel text-chat-text border border-chat-line shadow-chat-lg anim-presence-in'
