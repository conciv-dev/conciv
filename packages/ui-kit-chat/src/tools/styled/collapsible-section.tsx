...
const TRIGGER = `group w-full flex items-center gap-1.5 py-1 text-start text-[length:var(--chat-text-sm)] text-[color:var(--chat-text-2)] cursor-pointer select-none [background:transparent] [transition:color_120ms_var(--chat-ease)] hover:[color:var(--chat-text)] ${FOCUS_INSET}`
const CHEVRON =
...
const BODY = 'pl-4 pt-1 pb-1.5 text-[length:var(--chat-text-sm)] text-[color:var(--chat-text-2)]'
