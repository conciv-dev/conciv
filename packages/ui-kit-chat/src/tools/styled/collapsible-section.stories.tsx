...
function frame(child: JSX.Element): JSX.Element {
  return (
    <div class="p-4 rounded-[var(--chat-radius-md)] w-[30rem] [background:var(--chat-fill)] [border:1px_solid_var(--chat-line)] [font-family:var(--chat-font)]">
      {child}
    </div>
  )
}
...
export const NestedInsideCardBody: Story = {
  render: () =>
    frame(
      <>
        <p class="text-[length:var(--chat-text-md)] text-chat-text m-0 mb-2">tool-card body content</p>
