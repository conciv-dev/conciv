...
const JSON_TREE_TREE =
  'flex flex-col [&_[data-part=branch-control]]:flex [&_[data-part=branch-control]]:items-center [&_[data-part=branch-control]]:gap-1 [&_[data-part=branch-control]]:py-0.5 [&_[data-part=branch-control]]:pr-1 [&_[data-part=branch-control]]:cursor-pointer [&_[data-part=branch-control]]:rounded-[var(--chat-radius-sm)] [&_[data-part=branch-control]]:[padding-inline-start:calc((var(--depth)-1)*0.75rem)] [&_[data-part=branch-control]]:hover:[background:var(--chat-fill)] [&_[data-part=branch-control]]:focus-visible:[outline:0.125rem_solid_var(--chat-accent)] [&_[data-part=branch-control]]:focus-visible:[outline-offset:-2px] [&_[data-part=item]]:flex [&_[data-part=item]]:items-center [&_[data-part=item]]:gap-1 [&_[data-part=item]]:py-0.5 [&_[data-part=item]]:pr-1 [&_[data-part=item]]:rounded-[var(--chat-radius-sm)] [&_[data-part=item]]:[padding-inline-start:calc((var(--depth)-1)*0.75rem)] [&_[data-part=item]]:hover:[background:var(--chat-fill)] [&_[data-part=item]]:focus-visible:[outline:0.125rem_solid_var(--chat-accent)] [&_[data-part=item]]:focus-visible:[outline-offset:-2px] [&_[data-part=branch-indicator]]:inline-flex [&_[data-part=branch-indicator]]:items-center [&_[data-part=branch-indicator]]:justify-center [&_[data-part=branch-indicator]]:shrink-0 [&_[data-part=branch-indicator]]:[transition:rotate_150ms_var(--chat-ease)] [&_[data-part=branch-indicator][data-state=open]]:rotate-90 [&_[data-part=branch-text]]:flex-1 [&_[data-part=branch-text]]:min-w-0 [&_[data-part=branch-text]]:truncate [&_[data-part=item-text]]:flex-1 [&_[data-part=item-text]]:min-w-0 [&_[data-part=item-text]]:truncate [&_[data-kind=key]]:[color:var(--chat-text-3)] [&_[data-kind=colon]]:[color:var(--chat-text-3)] [&_[data-kind=preview-text]]:[color:var(--chat-text-3)] [&_[data-type=string]]:[color:var(--chat-accent-link)] [&_[data-type=number]]:[color:var(--chat-success)] [&_[data-type=boolean]]:[color:var(--chat-success)] [&_svg]:size-3 [&_svg]:shrink-0'
