...
const PILL =
  'rounded-[var(--chat-radius-pill)] [border:1px_solid_var(--chat-line)] px-3 py-1 text-[0.8125rem] [color:var(--chat-text-2)] [background:var(--chat-bg)] cursor-pointer [transition:background_140ms_var(--chat-ease),color_140ms_var(--chat-ease)] hover:[background:var(--chat-fill-strong)] hover:[color:var(--chat-text-hi)]'
