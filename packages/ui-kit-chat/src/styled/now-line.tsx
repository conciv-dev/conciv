...
const STOP_BUTTON = `text-[color:var(--chat-text-2)] hover:text-[color:var(--chat-danger)] text-[length:var(--chat-text-xs)] rounded-[var(--chat-radius-sm)] inline-flex flex-none size-5.5 cursor-pointer [background:var(--chat-fill)] [border:1px_solid_var(--chat-line)] items-center justify-center hover:[background:var(--chat-fill-strong)] ${FOCUS}`
