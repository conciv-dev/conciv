...
const PREVIEW =
  'max-h-64 overflow-y-auto flex flex-col-reverse [mask-image:linear-gradient(to_bottom,transparent,black_1.5rem,black_calc(100%-1.5rem),transparent)]'
