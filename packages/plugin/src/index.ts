...
// The devgent unplugin factory. vite = the rich hook (live viteBridge + widget middleware + boot).
...
export const unplugin = createUnplugin<DevgentConfig | undefined>((options = {}) => {
