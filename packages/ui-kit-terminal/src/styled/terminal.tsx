...
const SCREEN_WRAP =
  'flex flex-col flex-1 min-h-0 min-w-0 overflow-hidden transition-opacity duration-200 motion-reduce:transition-none'
...
const BANNER_BUTTON =
  'py-1.5 px-2.5 rounded-[7px] border-0 text-[0.6875rem] font-semibold cursor-pointer [background:var(--chat-accent,#4353ff)] [color:#fff]'
