...
import {runnerUnavailableError, type TestRunnerManager, type ListResult} from '@mandarax/protocol/runner-types'
import type {TestEvent, TestRunResult} from '@mandarax/protocol/test-types'
...
// the real vitest execution is covered by @mandarax/test-runner's own vitest IT.
