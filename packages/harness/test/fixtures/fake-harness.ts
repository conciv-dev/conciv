...
// DEVGENT_FAKE_FORMAT (claude | codex). Echoes argv (DEVGENT_TEST_ARGV_FILE) so a test can
// assert resume; hangs until SIGTERM under DEVGENT_FAKE_HANG to exercise Stop.
