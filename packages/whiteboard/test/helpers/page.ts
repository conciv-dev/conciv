...
// no extra dep; node_modules paths cover the package + workspace root.
...
// Serve one HTML page; mount the sync ws relay so browser fixtures can join rooms over the same
// origin. A fresh getPort keeps parallel suites from colliding.
