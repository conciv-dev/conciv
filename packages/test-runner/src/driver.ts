...
import type {Summary, TestRunResult, TestEvent, FileState} from '@mandarax/protocol/test-types'
import {
  defineRunner,
...
} from '@mandarax/protocol/runner-types'
...
export {isRunnerUnavailable, runnerUnavailableError} from '@mandarax/protocol/runner-types'
export type {RunnerUnavailableError} from '@mandarax/protocol/runner-types'
