...
const CONTENT =
  'hidden data-[state=open]:block data-[state=open]:anim-combo z-[2147483647] rounded-chat-surface-sm bg-chat-panel text-chat-text border border-chat-line shadow-chat-lg py-1 px-2 text-[0.6875rem] max-w-60 focus-visible:outline-none'
