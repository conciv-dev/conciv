...
const SCROLLBAR =
  'flex p-0.5 opacity-0 pointer-events-none [transition:opacity_150ms_var(--chat-ease)] [&[data-hover]]:opacity-100 [&[data-scrolling]]:opacity-100 [&[data-hover]]:pointer-events-auto [&[data-scrolling]]:pointer-events-auto [&[data-orientation=vertical]]:w-2 [&[data-orientation=horizontal]]:h-2 [&[data-orientation=vertical]:not([data-overflow-y])]:hidden [&[data-orientation=horizontal]:not([data-overflow-x])]:hidden'
const THUMB =
  'w-full rounded-chat-pill bg-chat-accent-link [&[data-orientation=horizontal]]:w-auto [&[data-orientation=horizontal]]:h-full'
