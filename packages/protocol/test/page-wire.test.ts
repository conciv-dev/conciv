...
describe('page wire envelope', () => {
  it('carries requestId, name and input and nothing kind-shaped', () => {
    const parsed = PageQuerySchema.parse({requestId: 'pq1', name: 'page.click', input: {selector: '#go'}})
    expect(parsed).toEqual({requestId: 'pq1', name: 'page.click', input: {selector: '#go'}})
  })
